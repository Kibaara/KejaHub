  ...
  return (
    <div className='relative py-24'>
        <Image
            ...
            alt='Kejahub Search Section Background'
            fill
        ...
        >
                <div className='flex flex-col md:flex-row justify-between items-center'>
                    ...
                    <div className='flex justify-center md:justify-start gap-4'>
                        ...
                        <Link
                           href='/signup'
                           className='inline-block text-white bg-secondary-500 rounded-lg px-6 py-3 font-semibold hover:bg-secondary-600 whitespace-nowrap'
                           scroll={false}
                        >
                            Sign Up
                        </Link>
